...
Some features (notably those that include “timeonice”) had already been filled to prevent missing values, although the filled values presented significant outliers. After identifying these features I was able to adjust the values to be more realistic and remove the noise they caused within the model.
EDA
...
Between XGBoost, CatBoost, and LightGBM, CatBoost performed the best, with the best iteration having a test logloss mean of 0.5166.
